...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nitdrv.peoplemanager.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nitdrv.peoplemanager.repository.UserRepository.USERS_BY_EMAIL_CACHE);
