...
type AddressFormGroupContent = {
  ...
  addressInfo: FormControl<IAddress['addressInfo']>;
  person: FormControl<IAddress['person']>;
};
...
export class AddressFormService {
  createAddressFormGroup(address: AddressFormGroupInput = { id: null }): AddressFormGroup {
    ...
    return new FormGroup<AddressFormGroupContent>({
      ...
      addressInfo: new FormControl(addressRawValue.addressInfo, {
        validators: [Validators.maxLength(300)],
      }),
      person: new FormControl(addressRawValue.person, {
        validators: [Validators.required],
      }),
    });
  }
